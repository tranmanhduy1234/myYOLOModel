...
| **08** | [Cơ chế Quản lý Checkpoint & Resume Training](08_Checkpoint_System.md) | Cấu trúc Checkpoint 8 Thành phần, Cơ chế Phôi tái lập State, Trích xuất Trunk State-Dict (`best_trunk.pt`) cho Transfer Learning, Atomic State Saving. |
